        ...
        <div class="card">
            ...
            <form action="doctors" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" required placeholder="Dr. John Doe" value="${editableDoc.name}">
                </div>
                <div class="form-group">
                ...
                <table>
                    ...
                    <tbody>
                        <c:forEach var="doc" items="${doctors}">
                            <tr>
                                ...
                                <td style="display: flex; gap: 10px;">
                                    <a href="doctors?action=edit&id=${doc.id}" class="btn btn-info btn-sm">Edit</a>
                        ...
                        <c:if test="${empty doctors}">
                            <tr>
                                <td colspan="5"
                                    style="text-align: center; color: var(--text-secondary); padding: 40px;">No doctors
                                    found.</td>
                            </tr>
                        </c:if>
                    </tbody>
